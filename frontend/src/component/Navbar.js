        ...
        {isAuth() ? (
          userType() === "recruiter" ? (
            <>
              ...
              <Typography style={{fontSize:"18px"}}>Post Jobs</Typography>
              </Button>
              <Button color="inherit" onClick={() => handleClick("/myjobs")}>
              <Typography style={{fontSize:"18px"}}>View Posted Jobs</Typography>
              </Button>
            ...
            <Button color="inherit" onClick={() => handleClick("/welcome")}>
              ...
              <Typography style={{fontSize:"18px"}}>Search Jobs</Typography>
              </Button>
              <Button
                color="inherit"
